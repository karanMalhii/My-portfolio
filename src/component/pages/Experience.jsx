            ...
            <div className="container px-4 md:px-6">
              ...
              <div className="mt-4">
                ...
                <p className="mt-2">
                  ...
                  Corp's core products. Worked with a team of five agile
                  developers to plan, design, and develop robust solutions in a
                  timely manner.
                </p>
              </div>
              <div className="mt-4">
                ...
                <p className="mt-2">
                  ...
                  programming software. Participated in agile teams and
                  effectively communicated with all team members.
                </p>
              </div>
            </div>
          </section>
